...
def validate_employee_response(data: Dict[str, Any]) -> bool:
    """
    Валидирует ответ API с данными сотрудника.
...
def validate_company_response(data: Dict[str, Any]) -> bool:
    """
    Валидирует ответ API с данными компании.
...
def validate_error_response(data: Dict[str, Any]) -> bool:
    """
    Валидирует ответ API с ошибкой.

    Args:
        data: Данные ответа от API

    Returns:
        bool: True если данные ошибки валидны, иначе False
    """
